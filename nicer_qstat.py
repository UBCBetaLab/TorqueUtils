...
"""
The goal of this script is to replace qstat, which often hides the things you actually care about and shows you things you don't. 
Not my original code, but I can't track down the source. Can be easily edited to further improve output. 
"""
